        ...
        <div class="api-container flex-auto">
            ...
            <details open class="turbogrid">
                ...
                <section>
                    ...
                    <div>The container argument can be a CSS selector, a DOM element, or an options object that includes
                        a container property.</div>
                    <pre><code class="language-js">
                            //selector
            ...
            <details open class="methods">
                ...
                <section>
                    ...
                    <div>The data object reads columns, rows, rowsLength, and options. rowsLength is useful when the
                        total row count is known before all rows are loaded.</div>
                    <pre><code class="language-js">
                            grid.setData({
                                columns: [],
                                rows: []
                ...
                <section>
                    ...
                    <div>Loads data from a plain snapshot by stripping private tg_* fields and rebuilding normalized
                        tree state for rows and columns.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>When keysSettings is omitted, private fields are removed. When keysSettings is provided, keys
                        set to true are included explicitly and keys set to false are excluded.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Returns the current option value for name, or the full options object when no name is provided.
                    </div>
                ...
                <section>
                    ...
                    <div>Supports both setFormatter(type, handler) and setFormatter(formatterMap). Registered handlers
                        run with the grid instance as this.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Returns the formatter function registered for the specified type, bound to the current grid
                        instance.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Binds an event handler to the grid. See <a href="#events">events</a> for supported event types.
                    </div>
                    <div>eventType can be a single event name, multiple names separated by spaces, or an object map of
                        event names to handlers. Namespaced events such as onUpdated.demo are supported.</div>
                ...
                <section>
                    ...
                    <div>Call without arguments to remove all handlers, with an event name or namespace to remove
                        matching handlers, or with both eventType and handler to remove a specific binding.</div>
                    <pre><code class="language-js">
                            grid.unbind();
                ...
                <section>
                    ...
                    <div>Repeated calls in the same tick are merged, so render is safe to call after batched updates.
                    </div>
                    <pre><code class="language-js">
                            grid.render();
                        </code></pre>
                ...
                <section>
                    ...
                    <div>Supports resize(), resize(width, height), and resize(styleMap) where styleMap is applied to the
                        grid holder.</div>
                    <pre><code class="language-js">
                            grid.resize();
                            grid.resize(600, 400);
                ...
                <section>
                    ...
                    <ol>
                        <li>If the parameter is a Number, the grid looks up the row or column by index. Negative indexes
                            are supported, so -1 resolves to the last item.</li>
                        <li>If the parameter is a String, the grid searches all items for a matching row or column id.
                        </li>
                        <li>If the parameter is an Object, the grid inspects these properties:</li>
                        <ul>
                            <li>If the object has a tg_index property, the grid looks up the row or column by index
                                first.</li>
                            <li>If the object has an id property of type String, the grid searches all items for a
                                matching id.</li>
                        </ul>
                    </ol>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>loading can be plain content, a DOM node, a factory function that receives the loading
                        container, or a default-loading options object such as { size, color, fast }.</div>
                    <pre><code class="language-js">
                            grid.showLoading();
                            grid.hideLoading();
                ...
                <section>
                    ...
                    <div>If the target row is a group with no loaded subs yet, expandRow may trigger onRowSubsRequest so
                        child rows can be loaded lazily.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Returns export-ready columns and rows with private fields removed, optionally filtered by
                        keysSettings.</div>
                ...
                <section>
                    ...
                    <div>Passing an array of subs updates the row tree immediately and marks the parent row as expanded.
                    </div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Use setRows when only the row tree changes. Use setData when columns or options also need to be
                        replaced.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>A view index is the current visible order after filtering, collapsing, sorting, and column
                        visibility changes.</div>
                ...
                <section>
                    ...
                    <div>parent can be a row reference, row index, or row id. position inserts at a specific child
                        index, and scrollTo defaults to true so the new row is brought into view.</div>
                    <pre><code class="language-js">
                            grid.addRow({
                                id: "id1",
                                name: "row item"
                ...
                <section>
                    ...
                    <div>rowList can be a single row or a list of rows. The move is ignored when offset is 0 or when all
                        visible rows are included.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>In multi-select mode, pass false as the only argument to clear all, pass false as the second
                        argument to unselect specific rows, or pass an event with Shift pressed to select a range from
                        the previous selection.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Calling setSortColumn repeatedly with the same column toggles sortAsc. removeSortColumn clears
                        the current sort state.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>width is rounded to an integer, clamped to 0 or greater, and updates the column width,
                        minWidth, and maxWidth together.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>parent can be a column reference, column index, or column id. position inserts at a specific
                        child index, and scrollTo defaults to true so the new column is brought into view.</div>
                    <pre><code class="language-js">
                            grid.addColumn({
                                id: "id1",
                                name: "column item"
                ...
                <section>
                    ...
                    <div>updateCell reads rowIndex and columnIndex using the normal row and column lookup rules.
                        Omitting rowData or cellValue rerenders the existing data.</div>
                    <div>flushBody clears all cached row renders. flushSort clears the row cache used after sorting.
                    </div>
                    <div>flushRow, flushRowFrom, flushColumn, flushColumnFrom, and flushCell use view indexes
                        (tg_view_index), not source indexes.</div>
                    <pre><code class="language-js">
                            grid.update();
                            grid.flushBody();
                            grid.flushSort();
                ...
                <section>
                    ...
                    <div>Returns 0 when no vertical scrollbar is present; otherwise returns <a
                            href="#options.scrollbarSize">scrollbarSize</a> when <a
                            href="#onScrollStateChanged">hasVScroll</a> is true.</div>
                    <a name="getScrollbarHeight">getScrollbarHeight()</a>
                    <div>Returns 0 when no horizontal scrollbar is present; otherwise returns <a
                            href="#options.scrollbarSize">scrollbarSize</a> when <a
                            href="#onScrollStateChanged">hasHScroll</a> is true.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>Returns the number of visible rows by default. Pass true to include collapsed or filtered rows.
                    </div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>The return value is a Query collection, which is useful when the same row is rendered in
                        multiple panes.</div>
                    <pre><code class="language-js">
                ...
                <section>
                    ...
                    <div>columns should be a list of column ids, and keywords is split on whitespace before matching.
                    </div>
                    <pre><code class="language-js">
                            grid.setOption({
            ...
            <details open class="options">
                ...
                <section>
                    ...
                    <div>Controls whether collapse-all actions are shown and whether they run during initialization.
                    </div>
                    <div>Demo <a href="row-collapse.html" target="_blank">Row Collapse/Expand</a></div>
                </section>
                ...
                <section>
                    ...
                    <div>Controls whether selection UI is shown and whether all rows are selected during initialization.
                    </div>
                    <div>For selectAllOnInit: true selects all, false clears all, and null leaves the current state
                        unchanged.</div>
                ...
                <section>
                    ...
                    <div>Controls whether dragged rows can move across levels. Accepts a boolean or a function that
                        returns the allowed drop list.</div>
                ...
                <section>
                    ...
                    <div>false places blank values at the bottom for descending sort and at the top for ascending sort.
                    </div>
                ...
                <section>
                    ...
                    <div>Configures frozen rows and columns. frozenRowHoverable enables hover styles and hover events on
                        frozen rows.</div>
            ...
            <details open class="tg">
                ...
                <section>
                    ...
                    <div>These private properties are removed when calling <a href="#exportData">exportData()</a> or <a
                            href="#getItemSnapshot">getItemSnapshot()</a>.</div>
                </section>
                ...
                <section>
                    ...
                    <table class="api-table api-table-zebra">
                        ...
                        <tr>
                            <td>tg_filtered</td>
                            <td>Boolean</td>
                            <td>true if the row was hidden by the <a href="#options.rowFilter">rowFilter</a> function.
                            </td>
                        </tr>
                        <tr>
                            <td>tg_row_number</td>
                ...
                <section>
                    ...
                    <table class="api-table api-table-zebra">
                        ...
                        <tr>
                            <td>tg_invisible</td>
                            <td>Boolean</td>
                            <td>true if the column was hidden by user via <a href="#hideColumn">hideColumn()</a> or the
                                invisible property.</td>
                        </tr>
                        <tr>
                            <td>tg_width</td>
                            <td>Number</td>
