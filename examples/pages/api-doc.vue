  ...
  <div class="main flex-auto flex-column">
    <div class="api-header">
      <div class="api-nav">
        ...
        <a href="#/api-doc?position=data">Data</a>
        <a href="#/api-doc?position=options">Options</a>
    ...
    <div class="api-container flex-auto">
      ...
      >
        <summary>
          <a name="turbogrid">Getting Started</a>
        </summary>
        ...
        <section>
          ...
          <div>
            The container argument can be a CSS selector, a DOM element, or an options object that includes
      ...
      >
        ...
        <section>
          ...
          <div>
            Loads data from a plain snapshot by stripping private tg_* fields and rebuilding normalized
            tree state for rows and columns.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            When keysSettings is omitted, private fields are removed. When keysSettings is provided, keys
            set to true are included explicitly and keys set to false are excluded.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            Supports both setFormatter(type, handler) and setFormatter(formatterMap). Registered handlers
            run with the grid instance as this.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            Returns the formatter function registered for the specified type, bound to the current grid
            instance.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            ...
            event names to handlers. Namespaced events such as onUpdated.demo are supported.
          </div>
        ...
        <section>
          ...
          <div>
            Call without arguments to remove all handlers, with an event name or namespace to remove
            matching handlers, or with both eventType and handler to remove a specific binding.
          </div>
          <pre><code class="language-js">
                            grid.unbind();
        ...
        <section>
          ...
          <div>
            Supports resize(), resize(width, height), and resize(styleMap) where styleMap is applied to the
            grid holder.
          </div>
          <pre><code class="language-js">
                            grid.resize();
        ...
        <section>
          ...
          <ol>
            <li>
              If the parameter is a Number, the grid looks up the row or column by index. Negative indexes
              are supported, so -1 resolves to the last item.
            </li>
            <li>
            ...
            <ul>
              <li>
                If the object has a tg_index property, the grid looks up the row or column by index
                first.
              </li>
              <li>
                If the object has an id property of type String, the grid searches all items for a
                matching id.
              </li>
            </ul>
          </ol>
        ...
        <section>
          ...
          <div>
            loading can be plain content, a DOM node, a factory function that receives the loading
            container, or a default-loading options object such as { size, color, fast }.
          </div>
          <pre><code class="language-js">
                            grid.showLoading();
                            grid.hideLoading();
        ...
        <section>
          ...
          <div>
            If the target row is a group with no loaded subs yet, expandRow may trigger onRowSubsRequest so
            child rows can be loaded lazily.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            Returns export-ready columns and rows with private fields removed, optionally filtered by
            keysSettings.
          </div>
        ...
        <section>
          ...
          <div>
            Use setRows when only the row tree changes. Use setData when columns or options also need to be
            replaced.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            A view index is the current visible order after filtering, collapsing, sorting, and column
            visibility changes.
          </div>
        ...
        <section>
          ...
          <div>
            parent can be a row reference, row index, or row id. position inserts at a specific child
            index, and scrollTo defaults to true so the new row is brought into view.
          </div>
          <pre><code class="language-js">
                            grid.addRow({
                                id: "id1",
        ...
        <section>
          ...
          <div>
            rowList can be a single row or a list of rows. The move is ignored when offset is 0 or when all
            visible rows are included.
          </div>
          <pre><code class="language-js">
        ...
        <section>
          ...
          <div>
            In multi-select mode, pass false as the only argument to clear all, pass false as the second
        ...
        <section>
          ...
          <div>
            Calling setSortColumn repeatedly with the same column toggles sortAsc. removeSortColumn clears
        ...
        <section>
          ...
          <div>
            width is rounded to an integer, clamped to 0 or greater, and updates the column width,
        ...
        <section>
          ...
          <div>
            parent can be a column reference, column index, or column id. position inserts at a specific
            child index, and scrollTo defaults to true so the new column is brought into view.
          </div>
          <pre><code class="language-js">
                            grid.addColumn({
                                id: "id1",
        ...
        <section>
          ...
          <div>
            updateCell reads rowIndex and columnIndex using the normal row and column lookup rules.
            Omitting rowData or cellValue rerenders the existing data.
          </div>
          <div>
            flushBody clears all cached row renders. flushSort clears the row cache used after sorting.
          </div>
          <div>
            flushRow, flushRowFrom, flushColumn, flushColumnFrom, and flushCell use view indexes
            (tg_view_index), not source indexes.
          </div>
          <pre><code class="language-js">
                            grid.update();
                            grid.flushBody();
        ...
        <section>
          ...
          <div>
            The return value is a Query collection, which is useful when the same row is rendered in
            multiple panes.
          </div>
          <pre><code class="language-js">
      ...
      >
        ...
        <section>
          ...
          <div>
            For selectAllOnInit: true selects all, false clears all, and null leaves the current state
            unchanged.
          </div>
        ...
        <section>
          ...
          <div>
            Controls whether dragged rows can move across levels. Accepts a boolean or a function that
        ...
        <section>
          ...
          <div>
            Configures frozen rows and columns. frozenRowHoverable enables hover styles and hover events on
            frozen rows.
          </div>
          <div>
            Demo <a
