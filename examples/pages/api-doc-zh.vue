    ...
    <div class="main flex-auto flex-column">
        <div class="api-header">
                <div class="api-nav">
                    <a href="#methods">方法</a>
                    <a href="#data">数据</a>
                    <a href="#options">配置项</a>
                    <a href="#events">事件</a>
                    <a href="#lifecycle">生命周期</a>
                </div>
                <div class="api-toolbar">
                    <div class="api-search">
                        <input class="api-search-value" type="text" placeholder="搜索 API" value="" />
            ...
            <div class="api-container flex-auto">
                ...
                <details open class="methods">
                    ...
                    <section>
                        ...
                        <div>同时支持 setFormatter(type, handler) 和 setFormatter(formatterMap)。已注册的处理函数执行时，this 指向当前 grid 实例。</div>
                        <pre><code class="language-js">
                            // 设置多个格式化器
                            grid.setFormatter({
                        ...
                        <div>示例 <a href="formatter.html" target="_blank">格式化器</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="events.html" target="_blank">事件</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="resize.html" target="_blank">尺寸调整</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="loading.html" target="_blank">显示/隐藏加载态</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-collapse.html" target="_blank">行折叠/展开</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="export.html" target="_blank">导出</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="load-subs.html" target="_blank">动态加载子项</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="set-rows.html" target="_blank">动态设置行</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-add-delete.html" target="_blank">行新增/删除</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-move.html" target="_blank">行移动</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-select.html" target="_blank">行选择</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="frozen-middle.html" target="_blank">中间冻结</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="sort.html" target="_blank">行排序</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="column-display.html" target="_blank">列宽调整</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="column-display.html" target="_blank">显示/隐藏列</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="column-add-delete.html" target="_blank">列新增/删除</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="scroll.html" target="_blank">滚动</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>flushRow、flushRowFrom、flushColumn、flushColumnFrom 和 flushCell 使用的都是 view 索引（tg_view_index），而不是源数据索引。</div>
                        <pre><code class="language-js">
                            grid.update();
                            grid.flushBody();
                            grid.flushSort();
                        ...
                        <div>示例 <a href="flush.html" target="_blank">刷新</a></div>
                    </section>

                    <section>
                        <a name="getScrollbarWidth">getScrollbarWidth()</a>
                        <div>没有垂直滚动条时返回 0；当 <a href="#onScrollStateChanged">hasVScroll</a> 为 true 时，返回 <a href="#options.scrollbarSize">scrollbarSize</a>。</div>
                        <a name="getScrollbarHeight">getScrollbarHeight()</a>
                        <div>没有水平滚动条时返回 0；当 <a href="#onScrollStateChanged">hasHScroll</a> 为 true 时，返回 <a href="#options.scrollbarSize">scrollbarSize</a>。</div>
                        <pre><code class="language-js">
                ...
                <details open class="data">
                    ...
                    <section>
                        ...
                        <div>示例 <a href="load-rows.html" target="_blank">动态加载行</a></div>
                    </section>
                ...
                <details open class="options">
                    ...
                    <section>
                        ...
                        <div>示例 <a href="theme.html" target="_blank">主题</a></div>
                    </section>
                    
                    <section>
                        <a name="options.rowHeight">rowHeight = 32</a>
                        <div>设置默认行高，单位为像素。</div>
                        <div>示例 <a href="multiple-instance.html" target="_blank">行高</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="cache.html" target="_blank">行/列缓存</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="auto-height.html" target="_blank">自动高度</a></div>
                        <a name="options.autoColumnWidth">autoColumnWidth = false</a>
                        <div>将容器剩余水平空间按比例分配到没有显式指定 <code>width</code> 的列上。有显式 <code>width</code> 的列被排除。使用列的 <code>widthWeight</code> 控制分配权重（默认 <code>1</code>）。配合 <code>bindContainerResize</code> 自动响应容器尺寸变化。</div>
                    ...
                    <section>
                        ...
                        <div>显示或隐藏表头区域。</div>
                        <div>示例 <a href="no-header.html" target="_blank">显示/隐藏表头</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>显示或隐藏内置行号列。</div>
                        <div>示例 <a href="row-number.html" target="_blank">行号</a></div>
                    </section>

                    <section>
                        <a name="options.rowNotFound">rowNotFound = ''</a>
                        <div>设置空状态内容。支持空字符串、字符串、DOM 元素或函数。</div>
                        <div>示例 <a href="row-not-found.html" target="_blank">空结果提示</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-drag.html" target="_blank">行拖拽</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-filter.html" target="_blank">行过滤</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="frozen.html" target="_blank">冻结</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="scrollbar.html" target="_blank">滚动条</a></div>
                    </section>
                    ...
                    <section>
                        ...
                        <div>示例 <a href="row-height.html" target="_blank">行高</a></div>
                    </section>
                    ...
                    <section>
                        <table class="api-table api-table-zebra">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>示例 <a href="touch.html" target="_blank">触摸</a></div>
                                </td>
                            </tr>
                ...
                <details open class="lifecycle">
                    ...
                    <section>
                        <table class="api-table">
                            ...
                            <tr>
                                <td rowspan="4">渲染</td>
                                <td colspan="2">初始化配置</td>
                                <td>低</td>
                                <td rowspan="5">全部 API</td>
                                <td rowspan="4">
                                    <pre><code class="language-js">
                                        grid.render();
                                        grid.rerender();
                            ...
                            <tr>
                                <td colspan="2">渲染表头</td>
                                <td>中</td>
                            </tr>
                            <tr>
                                <td rowspan="2">渲染主体</td>
                                <td>渲染行</td>
                                <td>中</td>
                            </tr>
                            <tr>
                ...
                <details open class="tg">
                    ...
                    <section>
                        ...
                        <div>调用 <a href="#exportData">exportData()</a> 或 <a href="#getItemSnapshot">getItemSnapshot()</a> 时，这些私有属性会被移除。</div>
                    </section>
