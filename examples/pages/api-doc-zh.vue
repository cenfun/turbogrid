        ...
        <div class="api-container flex-auto">
            ...
            <details open class="methods">
                ...
                <section>
                    ...
                    <div>同时支持 setFormatter(type, handler) 和 setFormatter(formatterMap)。已注册的处理函数执行时，this 指向当前 grid 实例。
                    </div>
                    <pre><code class="language-js">
                            // 设置多个格式化器
                            grid.setFormatter({
                ...
                <section>
                    ...
                    <div>flushRow、flushRowFrom、flushColumn、flushColumnFrom 和 flushCell 使用的都是 view
                        索引（tg_view_index），而不是源数据索引。</div>
                    <pre><code class="language-js">
                            grid.update();
                            grid.flushBody();
                            grid.flushSort();
                ...
                <section>
                    ...
                    <div>没有垂直滚动条时返回 0；当 <a href="#onScrollStateChanged">hasVScroll</a> 为 true 时，返回 <a
                            href="#options.scrollbarSize">scrollbarSize</a>。</div>
                    <a name="getScrollbarHeight">getScrollbarHeight()</a>
                    <div>没有水平滚动条时返回 0；当 <a href="#onScrollStateChanged">hasHScroll</a> 为 true 时，返回 <a
                            href="#options.scrollbarSize">scrollbarSize</a>。</div>
                    <pre><code class="language-js">
            ...
            <details open class="tg">
                ...
                <section>
                    ...
                    <div>调用 <a href="#exportData">exportData()</a> 或 <a href="#getItemSnapshot">getItemSnapshot()</a>
                        时，这些私有属性会被移除。</div>
                </section>
